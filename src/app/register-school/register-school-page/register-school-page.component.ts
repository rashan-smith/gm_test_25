...
export class RegisterSchoolPageComponent implements OnInit {
  ...
  redirectToCountry() {
    const loadingMsg =
      ...
      `<div class="loadContent"><ion-img src="assets/loader/new_loader.gif" class="loaderGif"></ion-img><p class="green_loader" [translate]="'searchCountry.check'">Detecting your country</p></div>`;
